...
export default function ProjectDetailClient() {
  ...
  const projectIndexPosition = projectIndex.findIndex((p) => p.slug === slug);
  ...
  const nextProject =
    projectIndexPosition >= 0 && projectIndexPosition < projectIndex.length - 1
      ...
      : null;
  const audioEmbed = <div className="text-sm text-black/50">Audio assets coming soon.</div>;
  ...
  return (
    <>
      <div className="relative min-h-screen bg-white text-black">
        ...
        <main className="relative z-[10] mx-auto max-w-[1600px] px-6 pb-8 pt-40 sm:px-8 lg:px-10 xl:px-12">
          <ProjectTemplate
            title="PROJECT TITLE"
            artist={artistLabel}
...
function ProjectTemplate({
  ...
  return (
    <div className="flex flex-col gap-24 snap-y snap-proximity">
      {/* HERO SECTION */}
      <section aria-label="Project hero" className="fade-section snap-start" data-fade-section>
      ...
      {/* AUDIO SECTION */}
      <section aria-label="Audio" className="fade-section snap-start" data-fade-section>
      ...
      <section aria-label="Creative direction" className="fade-section snap-start" data-fade-section>
      ...
      {/* PROCESS SECTION */}
      <section aria-label="Process" className="fade-section snap-start" data-fade-section>
        <div className="mx-auto w-full max-w-4xl space-y-5 py-16">
          <div className="h-px w-full bg-black/10 mb-8 mt-16" />
      ...
      {/* CREDITS SECTION */}
      <section aria-label="Credits" className="fade-section snap-start" data-fade-section>
        <div className="mx-auto w-full max-w-4xl space-y-5 py-16">
          <div className="h-px w-full bg-black/10 mb-8 mt-16" />
      ...
      <section aria-label="Previous and next" className="fade-section snap-start" data-fade-section>
        <div className="mx-auto w-full max-w-4xl">
          <div className="h-px w-full bg-black/10 mb-8 mt-16" />
          <div className="flex items-center justify-between gap-6 pt-10 pb-6 text-[12px] tracking-[0.2em] text-black/50">
            {prevProject ? (
