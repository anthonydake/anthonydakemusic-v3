            ...
            <section aria-label="Project hero" className="w-full translate-y-[3vh] border-y border-black/10 bg-white">
              <div className="mx-auto flex w-full max-w-4xl flex-col items-center justify-center px-6 py-7 text-center sm:py-8">
                <div className="space-y-6">
                  <div className="text-[8.5px] uppercase tracking-[0.28em] text-black/35">YEAR</div>
                  ...
                  <div className="text-[8.5px] uppercase tracking-[0.28em] text-black/45">ROLE · ROLE · ROLE</div>
                  <div className="text-[8.5px] uppercase tracking-[0.28em] text-black/40">{subtitleLabel}</div>
                </div>
              </div>
            </section>
                  ...
                  <div className="space-y-6">
                    {[0, 1].map((idx) => (
                      <div key={`streaming-${idx}`} className="border border-black/10 bg-white p-4">
                        <div className="text-[10.625px] uppercase tracking-[0.24em] text-black/70">Streaming Service</div>
